...
from task04 import eviction_policy as model_eviction_policy_mod
...
class CacheAccess(collections.namedtuple("CacheAccess", ("pc", "address", "set_id", "cache_lines", "access_history"))):
